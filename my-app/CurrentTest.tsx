...
// Copy your LiveGraph component here or import it if it's in a separate file
...
const AppTitle = () => (
  <View style={styles.titleContainer}>
    <Text style={styles.title}>Current Test</Text>
    <Text style={styles.subtitle}>Most Recent Test Data</Text>
  </View>
);
...
export default function CurrentTest() {
  ...
  const SERVER_URL = 'http://172.20.10.5:8000/history';
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (Array.isArray(data.tests) && data.tests.length > 0) {
            setDataPoints(data.tests[data.tests.length - 1]);
            setIsConnected(true);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('RealTime')} style={styles.button}>
        <Text style={styles.buttonText}>Back to Real-Time</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
